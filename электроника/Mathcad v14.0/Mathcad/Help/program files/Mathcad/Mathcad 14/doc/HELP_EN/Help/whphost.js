//	WebHelp 5.10.003 RoboHELP\WebHelp5Ext\template_stock
	...
	this.getDivHTML=function()
	{
		...
		if(gbMac&&gbIE4)
			...
			if (gbIE5)
				...
				sHTML+="<DIV ID="+this.msDivId+" ALIGN=left STYLE=\"position:absolute;z-index:1;left:2px;top:0;width:100%;height:"+parent.height+";visibility:hidden\">";
		sHTML+="</DIV>";
		return sHTML;
	}
}  
