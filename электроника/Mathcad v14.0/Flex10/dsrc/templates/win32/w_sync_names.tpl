...
// 12-May-04 K-03-02 $$5 TWH Drop ORA_NLS33; chg to ORACLE920
...
if "%mc%" == "i486_nt" "%prodir%\%mc%\obj\sync_names.exe" %* 
if NOT "%mc%" == "i486_nt" echo "The executable sync_names is supported only for SUN and NT platforms"
