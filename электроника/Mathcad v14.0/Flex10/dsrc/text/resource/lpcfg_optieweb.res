...
(Layout lpcfg_optieweb
    (Components
        (SubLayout                      lpcfg_optieweb2)
        (TextArea                       TextArea)
        (Label                          Label1)
    )
    ...
    (Resources
        ...
        (TextArea.Value                 "Specify the Info*Engine Web Server and User Name and Password for Authentication")
        ...
        (.Label                         "Info*Engine Web Server Authentication Settings")
        (.AttachLeft                    True)
        (.AttachRight                   True)
        (.AttachTop                     True)
        (.AttachBottom                  True)
...
(Layout lpcfg_optieweb2
    ...
    (Resources
        ...
        (.Label                         "Info*Engine Web Server Access Settings")
        (.Decorated                     True)
        (.AttachTop                     True)
        (.TopOffset                     5)
        (.BottomOffset                  5)
